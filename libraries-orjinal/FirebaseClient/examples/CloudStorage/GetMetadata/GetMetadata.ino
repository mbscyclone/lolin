...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        cstorage.getMetadata(aClient, GoogleCloudStorage::Parent(STORAGE_BUCKET_ID, "media.mp4"), options, processData, "getMetadataTask");

        // Async call with AsyncResult for returning result.
        cstorage.getMetadata(aClient, GoogleCloudStorage::Parent(STORAGE_BUCKET_ID, "media.mp4"), options, cloudStorageResult);
