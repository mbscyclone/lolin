/**
 * The example to download the object (file) from the Storage bucket.
 *
...
void loop()
{
    ...
    if (app.ready() && !taskComplete)
    {
        ...
        storage.download(aClient, FirebaseStorage::Parent(STORAGE_BUCKET_ID, "media.mp4"), getFile(media_file), processData, "⬇️  downloadTask");
