/**
 * The example to all the databases in the project.
 *
 ...
 * https://firebase.google.com/docs/firestore/reference/rest/v1/projects.databases/list
 *
...
void list_async()
{
    ...
    Databases.list(aClient, Firestore::Parent(FIREBASE_PROJECT_ID), processData, "listTask");
}
...
void list_async2()
{
    ...
    Databases.list(aClient, Firestore::Parent(FIREBASE_PROJECT_ID), firestoreResult);
}
