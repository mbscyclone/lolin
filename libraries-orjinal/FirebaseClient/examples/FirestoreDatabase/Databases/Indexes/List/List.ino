/**
 * The example to list the Firestore indexes.
 *
 ...
 * https://firebase.google.com/docs/firestore/reference/rest/v1beta1/projects.databases.indexes/list
 *
...
void list_async()
{
    ...
    indexes.list(aClient, Firestore::Parent(FIREBASE_PROJECT_ID), processData, "listTask");
}
...
void list_async2()
{
    ...
    indexes.list(aClient, Firestore::Parent(FIREBASE_PROJECT_ID), firestoreResult);
}
