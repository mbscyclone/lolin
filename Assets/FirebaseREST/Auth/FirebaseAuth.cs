...
namespace FirebaseREST
{
    ...
    {
        string EMAIL_AUTH_URL = "https://www.googleapis.com/identitytoolkit/v3/relyingparty/verifyPassword?key=";
        string CUSTOM_TOKEN_AUTH_URL = "https://www.googleapis.com/identitytoolkit/v3/relyingparty/verifyCustomToken?key=";
        string ANONYMOUS_AUTH_URL = "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=";
        string REFRESH_TOKEN_URL = "https://securetoken.googleapis.com/v1/token?key=";
        string USER_INFO_URL = "https://www.googleapis.com/identitytoolkit/v3/relyingparty/getAccountInfo?key=";
        TokenData tokenData;
        ...
        public void Awake()
        {
            ...
            //if (firebaseSettingscs.DATABASE_URL != "") { GameObject.Find("dbkayit-url-InputField").GetComponent<Text>().text = firebaseSettingscs.DATABASE_URL;}
            //if (firebaseSettingscs.WEB_API != "") { GameObject.Find("dbkayit-apikey-InputField").GetComponent<InputField>().text = firebaseSettingscs.WEB_API; }

              EMAIL_AUTH_URL = "https://www.googleapis.com/identitytoolkit/v3/relyingparty/verifyPassword?key=" + firebaseSettingscs.WEB_API;
              CUSTOM_TOKEN_AUTH_URL = "https://www.googleapis.com/identitytoolkit/v3/relyingparty/verifyCustomToken?key=" + firebaseSettingscs.WEB_API;
              ANONYMOUS_AUTH_URL = "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=" + firebaseSettingscs.WEB_API;
              REFRESH_TOKEN_URL = "https://securetoken.googleapis.com/v1/token?key=" + firebaseSettingscs.WEB_API;
              USER_INFO_URL = "https://www.googleapis.com/identitytoolkit/v3/relyingparty/getAccountInfo?key=" + firebaseSettingscs.WEB_API;
        }
