    ...
    public void OnButtonClick(string name)
    {
        ...
        switch (name)
        {
            case "save":
                ...
                if (Firebasesettingsobj.GetComponent<FirebaseSettings>().DATABASE_URL=="") { Firebasesettingsobj.GetComponent<Fbsave>().fbsave(); return; }
                if (Firebasesettingsobj.GetComponent<FirebaseSettings>().WEB_API == "") { Firebasesettingsobj.GetComponent<Fbsave>().fbsave(); return; }
