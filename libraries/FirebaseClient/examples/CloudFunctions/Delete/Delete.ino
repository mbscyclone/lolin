/**
 * The example to delete a function (Cloud Functions).
 *
...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        cfunctions.deleteFunction(aClient, GoogleCloudFunctions::Parent(FIREBASE_PROJECT_ID, PROJECT_LOCATION), "test" /* function name */, processData, "deleteTask");

        // Async call with AsyncResult for returning result.
        cfunctions.deleteFunction(aClient, GoogleCloudFunctions::Parent(FIREBASE_PROJECT_ID, PROJECT_LOCATION), "test" /* function name */, cloudFunctionsResult);
