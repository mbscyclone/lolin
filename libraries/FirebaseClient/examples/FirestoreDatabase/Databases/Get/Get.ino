/**
 * The example to get the information about a Firestore database.
 *
...
void get_async(const String &databaseId);
void get_async2(const String &databaseId);
void get_await(const String &databaseId);
...
void get_async(const String &databaseId)
{
    ...
    Databases.get(aClient, Firestore::Parent(FIREBASE_PROJECT_ID, databaseId /* database Id */), processData, "getTask");
}
...
void get_await(const String &databaseId)
{
    ...
    String payload = Databases.get(aClient, Firestore::Parent(FIREBASE_PROJECT_ID, databaseId /* database Id */));
