/**
 * The example to list all objects in Cloud Storage bucket.
 *
...
void loop()
{
    ...
    if (app.ready() && !taskCompleted)
    {
        ...
        cstorage.list(aClient, GoogleCloudStorage::Parent(STORAGE_BUCKET_ID), options, processData, "listTask");

        // Async call with AsyncResult for returning result.
        cstorage.list(aClient, GoogleCloudStorage::Parent(STORAGE_BUCKET_ID), options, cloudStorageResult);
