/**
 * The example for deleting a release.
 *
 ...
 * https://firebase.google.com/docs/reference/rules/rest/v1/projects.releases/delete
 *
...
void delete_release_async(const String &releaseId);
void delete_release_async2(const String &releaseId);
void delete_release_await(const String &releaseId);
...
void loop()
{
    ...
    if (app.ready() && !taskComplete)
    {
        ...
        delete_release_async(releaseId);

        // delete_release_async2(releaseId);

        // delete_release_await(releaseId);
    }
...
void delete_release_async(const String &releaseId)
{
    ...
    releases.remove(aClient, FIREBASE_PROJECT_ID, releaseId, processData, "releasesTask");
}
...
void delete_release_async2(const String &releaseId)
{
    ...
    releases.remove(aClient, FIREBASE_PROJECT_ID, releaseId, rulesResult);
}
